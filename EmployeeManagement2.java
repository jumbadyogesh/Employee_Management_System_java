/*
Q3. Create a class called Employee to hold empid, empname , empemail , empcontact and empsalary.
Using Encapsulation and Constructor using parameterized constructor to initialize instance variable of class
write a menu driven program in java that implements the working of a Employee Using create a set and get function
...
*/
		...
		class Employ
		{
			...
			public void setData(int id, String name, String email, int salary, long contact, String address)//setters
			{
				this.id=id;
				this.name= name;
				this.email=email;
